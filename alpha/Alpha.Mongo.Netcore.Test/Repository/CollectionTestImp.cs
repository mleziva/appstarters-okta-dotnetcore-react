...
{
    public class CollectionTestImp<TDocument> : IMongoCollection<TDocument>
    {
        ...
        //extension methods
        public static IFindFluent<TDocument, TDocument> Find(FilterDefinition<TDocument> filter, FindOptions options = null)
        {
            var findFluentMock = new Mock<IFindFluent<TDocument, TDocument>>();
